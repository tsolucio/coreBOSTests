...
$em->registerHandler('corebos.header', 'build/coreBOSTests/loadcbxhgui.php', 'coreBOSxhguiLoader');
$em->registerHandler('corebos.audit.action', 'build/coreBOSTests/loadcbxhgui.php', 'coreBOSxhguiLoader');
echo "<h4>Event corebos.header::coreBOSxhguiLoader registered.</h4>";
